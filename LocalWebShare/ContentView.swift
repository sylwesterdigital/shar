...
private let recentDeveloperUpdates: [DeveloperUpdate] = [
    .init(version: "2.2.36", date: "2026-08-31", title: "Private local captions + responsive spectrum", summary: "Removed every online transcription path. Captions now require on-device Speech, preprocess audio locally into short mono PCM sections, and never upload audio. Live spectrum uses denser 20-band analysis with a 30 Hz playback clock."),
    .init(version: "2.2.35", date: "2026-08-31", title: "Live spectrum + resilient captions", summary: "Made the iOS frequency bars move continuously with playback, split long audio into caption-sized chunks, and added an explicit Apple online transcription fallback when on-device Speech cannot process the track."),
    .init(version: "2.2.34", date: "2026-08-31", title: "Audio continuity + visual captions", summary: "Kept iOS audio playback continuous when moving from a library thumbnail into full Preview, added tap-switchable spectrum/waveform visualization, and added optional synchronized on-device Apple speech captions with the current word highlighted."),
