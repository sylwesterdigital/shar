...
final class LocalHttpServer {
    ...
    private void handle(Socket socket) {
        try (socket; BufferedInputStream in = new BufferedInputStream(socket.getInputStream()); BufferedOutputStream out = new BufferedOutputStream(socket.getOutputStream())) {
            ...
            else if (method.equals("GET") && path.equals("/3d-viewer.js")) sendThreeDViewerJs(out);
    ...
    private void sendThreeDViewerJs(OutputStream out) throws IOException {
        byte[] b=THREE_D_VIEWER_JS.getBytes(StandardCharsets.UTF_8); writeHeaders(out,"200 OK",b.length,"application/javascript; charset=utf-8",null); out.write(b);
    }

    private static final String THREE_D_VIEWER_JS = """
...
""";
    ...
    private static final String WEB_PAGE = new StringBuilder()
        .append("""
        <!doctype html>
        <html lang="en">
        <head>
        ...
        <body data-button-mode="icons" data-view="grid" data-theme="ocean">
          ...
          <dialog id="developerInfo">
            ...
            <div class="updates">
              <div class="update"><div class="update-head"><span class="update-version">v2.2.445</span><span class="update-title">iOS Debug-dylib linkage verification fix</span><span class="update-date">2026-08-31</span></div><p>Fixes the iOS launch-contract verifier for Xcode 16 Debug builds, where LocalWebShare.debug.dylib carries the weak Whisper dependency instead of the executable stub.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.444</span><span class="update-title">Android Whisper packaging memory fix</span><span class="update-date">2026-08-31</span></div><p>Stores the large local Whisper model uncompressed in Android packages and gives Gradle controlled heap headroom, fixing the release asset-compression memory failure.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.443</span><span class="update-title">Persistent Whisper cache + network recovery</span><span class="update-date">2026-08-31</span></div><p>Preserves validated local Whisper dependencies across releases, resumes interrupted downloads, and makes Apple signing/notarization more tolerant of unstable connections.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.442</span><span class="update-title">Notary recovery + watcher quarantine</span><span class="update-date">2026-08-31</span></div><p>Made macOS notarization resilient to transient Apple-network outages and stopped malformed stable ZIP packages from rerunning on every watcher poll.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.44</span><span class="update-title">Apple launch crash + Whisper isolation</span><span class="update-date">2026-08-31</span></div><p>Fixed Apple-client startup around the optional local Whisper runtime. Captions stay local/offline and runtime incompatibility no longer takes down Shar.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.43</span><span class="update-title">macOS Whisper platform/compiler fix</span><span class="update-date">2026-08-31</span></div><p>Fixed the macOS local-Whisper C bridge compiler flags and now requires the MacOSX XCFramework platform before accepting a universal framework slice.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.42</span><span class="update-title">Coloured build + watcher output</span><span class="update-date">2026-08-31</span></div><p>Added shared TTY-aware terminal styling across the foreground watcher and release/build scripts while redirected logs remain plain text.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.41</span><span class="update-title">Whisper Apple-mode build exit fix</span><span class="update-date">2026-08-31</span></div><p>Fixed successful Apple-only Whisper preparation returning status 1 and aborting the macOS release before compilation under set -e.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.40</span><span class="update-title">macOS Whisper build handoff hardening</span><span class="update-date">2026-08-31</span></div><p>Hardened macOS local-Whisper framework selection and pre-compile diagnostics; fixed an Android Developer Updates Java declaration regression.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.39</span><span class="update-title">Whisper Release-asset pin fix</span><span class="update-date">2026-08-31</span></div><p>Corrected the strict Apple whisper.cpp XCFramework integrity pin to the SHA-256 and byte count of the actual GitHub Release asset; local captions remain fully offline.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.38</span><span class="update-title">Whisper dependency download hardening</span><span class="update-date">2026-08-31</span></div><p>Kept local-only cross-platform Whisper and hardened Apple dependency preparation with verified retries when a direct GitHub release download is corrupted or stale.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.37</span><span class="update-title">Cross-platform local Whisper + audio parity</span><span class="update-date">2026-08-31</span></div><p>iOS, macOS and Android now share local captions plus switchable Live spectrum / whole-track Waveform. Caption media never leaves the device.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.36</span><span class="update-title">Private local captions + responsive spectrum</span><span class="update-date">2026-08-31</span></div><p>Hardened the first local-only caption prototype and improved the iOS 20-band spectrum; the caption engine is superseded by local Whisper in v2.2.37.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.35</span><span class="update-title">Live spectrum + resilient captions</span><span class="update-date">2026-08-31</span></div><p>Improved iOS spectrum timing and chunked caption processing; the temporary caption engine is superseded by fully local Whisper in v2.2.37.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.34</span><span class="update-title">Audio continuity + visual captions</span><span class="update-date">2026-08-31</span></div><p>Introduced persistent iOS Preview playback, spectrum/waveform visualization and synchronized highlighted caption UI.</p></div>
              <div class="update"><div class="update-head"><span class="update-version">v2.2.33</span><span class="update-title">Remote Share help + media feedback</span><span class="update-date">2026-08-31</span></div><p>Simplified the iOS Secure Remote Share flow with bottom-left quick Help and added clearer pressed/active Grid-card feedback on iOS and macOS.</p></div>
              ...
              <p>Kept iOS background audio while restoring the macOS release build.</p></div>
              <p>Audio can continue with Shar minimized or the iPhone screen locked.</p></div>
              <p>Images fit the viewer and previews gained a persistent X close control.</p></div>
              <p>Added Photos & Videos, camera recording, and Files from the + menu.</p></div>
              <p>Renamed the visible product to Shar and added the persistent iOS + importer.</p></div>
            </div>
          </dialog>
...
""")
        .append("""
          <script>
            ...
            async function remoteAPI(path,opt={}){const r=await fetch(REMOTE_API+path,{cache:'no-store',...opt,headers:{'Content-Type':'application/json','X-Shar-Client':'browser-sender-2.2.445',...(opt.headers||{})}});let j={};try{j=await r.json()}catch{}if(!r.ok)throw Error(j.error||`HTTP ${r.status}`);return j}
