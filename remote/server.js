...
const server=http.createServer(async (req,res) => {
  ...
  if (req.method==='GET' && parts.length===1 && parts[0]==='health') return json(res,200,{ok:true,service:'shar-remote',version:'2.1.5',sessions:sessions.size,turn:!!(TURN_HOST&&TURN_SECRET),security:'e2ee-pin-approval'});
